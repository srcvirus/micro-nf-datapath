...
void protobuf_AssignDesc_micronf_5fconfig_2eproto() {
  ...
  static const int PacketProcessorConfig_offsets_[8] = {
...
void protobuf_AddDesc_micronf_5fconfig_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\024micronf_config.proto\"\307\002\n\025PacketProcess"
    ...
    "tance_id\030\006 \002(\005\022\022\n\nshare_core\030\007 \002(\010\022\027\n\017se"
    "maphore_cpuid\030\010 \002(\005\0323\n\021PpParametersEntry"
    "\022\013\n\003key\030\001 \001(\t\022\r\n\005value\030\002 \001(\t:\0028\001\"\375\001\n\nPor"
    "tConfig\022\022\n\nport_index\030\001 \002(\005\022\'\n\tport_type"
    "\030\002 \002(\0162\024.PortConfig.PortType\022\022\n\nport_cla"
    "ss\030\003 \002(\t\0228\n\017port_parameters\030\004 \003(\0132\037.Port"
    "Config.PortParametersEntry\0325\n\023PortParame"
...
#define ZR_(first, last) do {\
  ...
  if (_has_bits_[0 / 32] & 231u) {
    ...
    ZR_(instance_id_, semaphore_cpuid_);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_share_core;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_semaphore_cpuid;
        break;
      }
...
// @@protoc_insertion_point(class_specific_merge_from_start:PacketProcessorConfig)
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_share_core()) {
      set_share_core(from.share_core());
    }
    if (from.has_semaphore_cpuid()) {
      set_semaphore_cpuid(from.semaphore_cpuid());
    }
  }
